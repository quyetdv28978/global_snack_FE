          ...
          <div class="flex">
            <div class="p-col-6">
              ...
              <div class="item">
                <div class="flex">
                  <label>Tên: </label>
                  <InputText id="ten" name="ten" type="text" v-model.trim="ten" :class="{ 'p-invalid': tenError }"
              ...
              <div class="item">
                <label>Email: </label>
                <InputText id="email" v-model.trim="email" required="true" autofocus
              ...
              <div class="col-12">
                <div class="Field col-12 md:col-6"
                  ...
                  <div style="display: block">
                    <div class="t"
                         style="border: 1px solid black; border-radius: 10px; width: 250px; height: 230px; margin-top: -60px">
                      <img :src="image" alt="image"
                           style="width: 230px; height: 220px; top: 50%; left: 50%; transform: translate(4%, 2%)"/>
                    </div>
