...
onClickOutside(messageBox, (evt) => {
    isChatPanelDisplayed.value = false;
});
</script>
...
<template>
    <div class="chat-panel" :class="isChatPanelDisplayed ? 'w-26rem' : null">
        ...
        <Button label="CSKH" rounded severity="help" class="chat-button w-5rem h-5rem" iconPos="top" @click="isChatPanelDisplayed = !isChatPanelDisplayed">
            <template #icon>
