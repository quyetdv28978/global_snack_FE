                            ...
                            <div class="p-fluid formgrid grid">
                                <div class="Field col-12 md:col-6" style="margin-bottom: 20px">
                                    <div style="height: 90px">
                                        ...
                                        <InputText placeholder="Nhập họ và tên" type="text" v-model="ten" :class="{ 'p-invalid': tenError }" class="w-full md:w-25rem mb-5" style="padding: 1rem" />
                                    </div>
                                ...
                                <div class="Field col-12 md:col-6" style="margin-bottom: 20px">
                                    <div style="height: 90px">
                                        ...
                                        <InputText placeholder="Nhập email" type="email" v-model="email" autofocus :class="{ 'p-invalid': emailError }" class="w-full md:w-30rem mb-5" style="padding: 1rem" />
                                    </div>
                                ...
                                <div class="Field col-12 md:col-6" style="margin-bottom: 20px">
                                    <div style="height: 90px">
                                        ...
                                        <InputText placeholder="Nhập số điện thoại" type="text" v-model="sdt" autofocus :class="{ 'p-invalid': sdtError }" class="w-full md:w-25rem mb-5" style="padding: 1rem" />
                                    </div>
                                ...
                                <div class="Field col-12 md:col-6" style="display: flex">
                                    <div>
                                        ...
                                        <Calendar dateFormat="mm/dd/yy" placeholder="Enter birth date" v-model="ngaySinh" :class="{ 'p-invalid': ngaySinhError }" class="w-full md:w-10rem mb-5" />
                                ...
                                <div class="Field col-12 md:col-6" style="margin-bottom: 10px">
                                    <div style="height: 90px">
                                        ...
                                        <Password
                                            ...
                                            v-model="xacNhanMK"
                                            autofocus
                                            :class="{ 'p-invalid': xacNhanMKError }"
                                            :toggleMask="true"
                                            class="w-full mb-3"
                                            inputClass="w-full"
                                            inputStyle="padding:1rem"
