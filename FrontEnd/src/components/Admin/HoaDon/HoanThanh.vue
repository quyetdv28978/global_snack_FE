...
const loadData = async () => {
    await useHD.fetchDataByStatus(3);
    data.value = useHD.dataHoanThanh;
    useHD.dataHoanThanh = useHD.dataHoanThanh;
};
...
const searchDate = async () => {
    ...
    // if (hinhThucGiao.value == 'tatCa' || hinhThucGiao.value == null) {
    ...
    //         const respone = await useHD.searchDateByTrangThai(startDate.value, endDate.value, 'ngayTao', 3);
    //         data.value = respone;
    //     } else {
    //         const respone = await useHD.searchDateByTrangThai(startDate.value, endDate.value, typeSearchDate.value.value, 3);
    //         data.value = respone;
    //     }
    // } else {
    //     if (startDate.value == null || startDate.value.length <= 0 || endDate.value == null || endDate.value.length <= 0) {
    ...
    //     } else if (typeSearchDate.value == null) {
    //         const respone = await useHD.searchDateByTrangThaiAndHinhThucGiao(startDate.value, endDate.value, 'ngayTao', 3, parseInt(hinhThucGiao.value));
    //         data.value = respone;
    //     } else {
    //         const respone = await useHD.searchDateByTrangThaiAndHinhThucGiao(startDate.value, endDate.value, typeSearchDate.value.value, 3, parseInt(hinhThucGiao.value));
    //         data.value = respone;
    //     }
    // }
...
const loadDataByHinhThucGiao = async (data) => {
    await useHD.fetchDataByStatusAndHinhThucGiao(3, data);
};

const loadDataByPttt = async (pttt) => {
    await useHD.fetchDataByStatusAndPttt(3, pttt);
};
