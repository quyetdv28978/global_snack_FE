...
<template>
    <Toast />
    <Loading v-model:active="uiBlock" :can-cancel="false" :is-full-page="true" color="#007bff" bgColor="#ffffff" height="80" width="80" loader="spinner" :lock-scroll="true" />
    <div class="h-screen flex justify-content-center align-items-center">
        <div class="surface-card p-5 shadow-2 border-round w-3">
            <div class="text-center mb-5">
                <img src="/src/assets/images/logo.jpg" alt="Image" height="80" />
